...
7. When todo work requires email lookup, drafting, labelling, archiving, or sending, use Craig's personal Gmail account by default, not Sloop or another work mailbox, unless Craig explicitly names a different account.
...
When Gmail is available and needed for personal todo work, default to Craig's personal Gmail account. Do not use Sloop email for personal todo tasks unless Craig explicitly asks for it.
