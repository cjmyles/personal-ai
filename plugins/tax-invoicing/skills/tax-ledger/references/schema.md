...
- When reconciling a later statement, follow `statement-reconciliation.md`: require a definite unique match before replacing an estimate, preserve its FX audit, and never treat statement repayment as another expense.
